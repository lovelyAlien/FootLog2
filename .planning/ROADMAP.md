...
- [ ] 07-07-PLAN.md — 과거 날짜 뷰 인라인 회고 편집 (wave 3)
- [ ] 07-08-PLAN.md — /reflection 모달 라우트 등록 + 알림 탭 딥링크 게이트 (wave 4)
- [ ] 07-09-PLAN.md — 오늘 뷰 "오늘 돌아보기" 상시 진입 행 + 개수 미표시 가드 (wave 5)
...
| 7. Day-end Reflection | 5/10 | In Progress|  |
